...
// Printed i, typed code in console.log


// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy
// Unicode is a global encoding standard for use from languages and code, Unicode translates the code within the device/internet for our understanding. 
var z = 'Teddy'
...
var f = 'heyo'
console.log(f.startsWith('heyo'))
// Now use any variable with endsWith() and return false
console.log(r.endsWith())
...
console.log(pizzaSentence.slice( 0,-20))
...
// Create a variable with a string value with some extra loving on both sides.
 const lovehandletax = '          I gotta bring tissues everwhere with me          '
 console.log(lovehandletax.trim())
// =================================================
//                     BOOLEAN
// =================================================
...
for(room = 0; room <=10; room++ ){
  console.log(room + ' Am I dizzy?')

}
console.log('i think i am')
// Harry said that was so mean of Teo to do Ken dirty like that. Make Teo's vision spin 20 times FOR LOOP.
for(vision = 1; vision <=20; vision++){
  console.log(vision)
}
...
for(const why in whateverQueenBeySaid){
  console.log(`${why}`)
}
// Using (FOR IN LOOP), print the indexes of the array.
const lana = ['l', 'a', 'n', 'a']
for(var uhm in lana){
  console.log(`${lana[uhm]}`)
}
// USE (FOR OF LOOP)!
const tia = ['teo', 'the', 'syntax', 'of', 'this', 'is', 'cleaner']
for(const hm of tia){
  console.log(hm)
  // so rather using the dollar sign symbol, I can just type out the variable or string?? whats the use of the for in loop?
...
var g = 'PS'
perscholas.forEach(element => console.log(element + ` ${g}`));
...
const exoticFruits = ['Avocado','Salak','Chempedak ']
...
console.log(fruitbasket[6],fruitbasket[7])
...
let changetoarray = RafaelNoBadWords.split(" ")
let result = changetoarray.filter(n => n.length < 7)
let returntostring = result.join(' ')
console.log(returntostring)
...
var sumup = numbersToAddUp.reduce((l,n) => l + n)
console.log(sumup)
// ===== SPREAD OPERATOR ===== 

// Create a variable and assign a value of a copied array using the spread operator
var ok = [1,2,3, ...exoticFruits]
...
var why = donutShop[1]
var please = why[0]
var neveragain = please[1]
console.log(neveragain)
var friend = donutShop [2]
var friendly = friend[0]
var friendlier = friendly[0]
var friendliest = friendlier[1]
console.log(friendliest[0])
// =================================================
//                     IF/ELSE
// =================================================
...
var m = 'Teo is a person'
if(m === 'Teo is a person'){
...
if(f === 'male'){
  ...
  console.log('Teo is going to remove you from the class.')
}
...
var Gustavoisthecoolest = 'Gustavo is the coolest'
var cool = Gustavoisthecoolest ? "You got that right!":"James wants to argue. He says he's the best!";
console.log(cool)
// not too sure about this operator, whats the point of it? and how do I get it to print the other string?
...
function helloe(z = 'hello'){

  var cya = function goodbye(){
    return z = 'hello'
  }
  return cya = 'goodbye ' + z

}
console.log(helloe())

// couldnt use 'hello' because the terminal is too nitpicky 
// Create a function expression with your first name as the variable and then print your first and last name
const Robert = function(){
  return 'Robert Samboy'
}
console.log(Robert())
...
let locationproperty = human.locationproperty
...
// Print overgrow
var again = bulbasaur.abilities
var again1 = again
var again2 = again1[0]
var again3 = again2
console.log(again3.ability)

// Print cut
var repeat = bulbasaur.moves
var repeat1 = repeat[2]
console.log(repeat1)

// Print Bulbahhhh!!!!!

var insanity = bulbasaur.sound
var insanity1 = insanity()
console.log(insanity1)
...
var array = Object.keys(bulbasaur)
    .map(function(key) {
        return bulbasaur[key];
    });
    console.log(bulbasaur)

// Print every single properties one by one in the console
var prop = Object.keys(bulbasaur).join()
console.log(prop)
// Print an array that contains every single values in bulbasaur
var array1 = Object.keys(bulbasaur).map(function(key) {
return bulbasaur[key]
})
